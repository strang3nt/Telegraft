...
import com.telegraft.statemachine.projection.RepositoryProjection
...
object Main {
  ...
  def init(stateMachine: ActorRef[StateMachine.Command], system: ActorSystem[_]): Unit = {
    ...
    TelegraftStateMachineServer.start(grpcInterface, grpcPort, system, grpcService)
  }
